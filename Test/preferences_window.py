...
class WallpapersSelector(Gtk.ScrolledWindow):
    ...
    path = f'{"/home/nick/Documents/Komorebi/"}/'
...
class PreferencesWindow(Gtk.Window):
    ...
    def __init__(self):
        ...
        utilities.apply_css([self.notebook], self.notebook_css)
        utilities.apply_css([self.info_bar], self.info_bar_css)
        utilities.apply_css([self.header_bar, self.hide_button, self.quit_button, self.donate_button,
        ...
        self.about_grid.attach(Gtk.Image.new_from_resource('/org/komorebi-team/komorebi/svg'), 0, 0, 1, 1)
        ...
        if not utilities.can_play_videos():
    ...
    def set_wallpaper_name_label(self):
        pretty_name = utilities.beautify_wallpaper_name(Settings.wallpaper_name)
