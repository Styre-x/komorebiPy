...
class Screen(Gtk.Window):
    ...
    def __init__(self, monitor_index):
        ...
        self.exit_item = BubbleMenuItem(f"Exit", self.menu_exit)
    ...
    def on_settings_changed(self, setting_key):
        ...
        new_overlays = utilities.on_settings_changed(self, setting_key)
    ...
    def load_wallpaper(self, name):
        ...
        wallpaper_info = utilities.get_wallpaper_config_file(name)
        wallpaper = utilities.load_wallpaper(self, wallpaper_info)
        overlays = utilities.load_overlays(self, wallpaper_info)
